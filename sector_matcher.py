...
if __name__ == "__main__":
    ...
    test_cases = [
        "conseil de gestion",  # Should match "Activites des sieges sociaux ; conseil de gestion"
        "Restauration",  # Exact match
        "restauration",  # Case insensitive
        "activites juridiques",  # Should match "Activites juridiques et comptables"
        "Commerce de detail",  # Should match the full version
        "informatique",  # Should match "Programmation, conseil et autres activites informatiques"
        "BTP",  # Might not match
        "Construction",  # Should match "Construction de batiments"
    ]
    
    print("Sector Matcher Test Results:")
    print("=" * 60)
